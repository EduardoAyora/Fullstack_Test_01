...
export const TaskItem = ({
  ...
  return (
    <article className="relative rounded-xl border border-white/10 bg-slate-700/30 p-4 pr-12 shadow-lg ring-1 ring-white/5">
      <button
        type="button"
        onClick={() => onRemove(task._id)}
        className="absolute right-3 top-3 inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/10 bg-white/5 text-xs text-slate-100 transition hover:border-rose-400/70 hover:bg-rose-500/20 hover:text-rose-100"
